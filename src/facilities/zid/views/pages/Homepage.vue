<template>
  ...
  <p>
    Indy Center is an integrated pilot and controller community on the VATSIM network. We simulate immersive aviation
    and air traffic operations within the Indianapolis ARTCC; approximately 73,000 square miles of airspace over parts
    of Indiana, Illinois, Kentucky, Ohio, West Virginia, Virginia, and Tennessee. The best part is anyone who is a
    member of the VATSIM network in good standing can automatically join! Come check out some fun events, learn to
    control, join a group flight, or just chat with fellow flight sim enthusiasts on our Discord.
  </p>
  <div class="grid grid-cols-4 gap-4">
    ...
    <div class="col-span-4 lg:col-span-1 h-min space-y-4">
      <div class="card">
        ...
        <p>
          <a class="text-alaska-gold" href="https://discord.gg/quYNCbnDfw">Join the Indy Center Discord</a>, the best
          place to keep up with the community.
        </p>
      </div>
      <div class="card">
        <OnlineControllers />
