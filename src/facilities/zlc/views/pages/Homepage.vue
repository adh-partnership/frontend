<template>
  <h1 class="text-2xl">Welcome to the Salt Lake City ARTCC</h1>
  <p>
    Welcome to Salt Lake City ARTCC! The Salt Lake City ARTCC covers approximately 350,000 square miles of airspace over
    all or part of the states of Oregon, Idaho, Montana, North Dakota, South Dakota, Wyoming, Utah, and Nevada.
  </p>
  <div class="grid grid-cols-4 gap-4">
    ...
    <div class="col-span-4 lg:col-span-1 h-min space-y-4">
      ...
      <div class="card">
        <WeatherTable
          :stations="['KSLC', 'KJAC', 'KBIL', 'KBOI', 'KBZN']"
          rules
          show-updated
          sort
          title
